        ...
        @forelse($feeds as $feed)
            <div class="feed card mb-4 shadow-sm">
                <div class="card-header d-flex align-items-center">
                    <img src="{{ $feed->user->avatar_url ?? asset('images/default_avatar.jpg') }}" alt="User" class="rounded-circle me-2" width="40" height="40">
                ...
                <div id="comments-{{ $feed->id }}" class="comments mt-3" style="display: none;">
                    @auth
                        <form action="{{ route('comments.store', ['feed' => $feed->id]) }}" method="POST" class="mb-2">
                            @csrf
