        ...
        <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="sellCarDropdown">
                        <a class="dropdown-item" href="<?php echo e(route('signup')); ?>">Sell Privately</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route(name: 'login')); ?>">Sign In</a>
                </li>
                <li class="nav-item">
...
<div class="offcanvas-menu" id="mobileMenu">
    ...
    $('.collapse').collapse();
            ...
            $('.view-car').on('click', function() {
                $.ajax({
                    url: '<?php echo e(route("cars.view")); ?>',
                    method: 'POST',
                    data: {
...
</html><?php /**PATH C:\xampp\htdocs\FastFinanceCars\resources\views/layouts/index.blade.php ENDPATH**/ ?>