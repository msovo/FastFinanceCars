    ...
    <div class="container py-4">
        ...
        <div class="row mt-4" style="background-color: #b22222; height: 200px;">
            ...
            <div class="col-md-6 col-12 d-flex flex-column justify-content-center align-items-center">
                ...
                <a href="<?php echo e(route('affordability')); ?>" class="btn btn-primary w-75">Calculate Affordability</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\FastFinanceCars\resources\views/layouts/footer.blade.php ENDPATH**/ ?>